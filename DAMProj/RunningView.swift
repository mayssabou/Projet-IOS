...
struct RunningView: View {
    ...
    let videoURL = Bundle.main.url(forResource: "Running", withExtension: "mp4")
    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                // Description
                Text("""
                Running is a physical activity beneficial for heart health, weight management, and endurance.
