...
struct YogaView: View {
    ...
    let videoURL = Bundle.main.url(forResource: "Yoga", withExtension: "mp4")
    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                // Description
                Text("""
                Yoga is an ancient practice that combines postures, breathing techniques, and meditation to improve flexibility, strength, and mental well-being. It's ideal for:
...
// Extension couleur hexadécimale
extension Color {
    init(hex: String) {
